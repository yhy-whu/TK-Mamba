...
ORGAN_DATASET_DIR = '/root/autodl-tmp/data/'
ORGAN_LIST = '/root/autodl-tmp/TK_Mamba/dataset/dataset_list/PAOT_10.txt'
NUM_WORKER = 16
NUM_CLASS = 11

## full list

TRANSFER_LIST = [ '10_03','10_06','10_07','10_08','10_10', '10_11']#
#现有器官编号
TEMPLATE={
    '10_03': [1,6],
    '10_06': [7],
...
class ToTemplatelabeld(MapTransform):
    ...
    def __call__(self, data: Mapping[Hashable, NdarrayOrTensor]) -> Dict[Hashable, NdarrayOrTensor]:
        ...
        if dataset_index == 1 or dataset_index == 2:
            ...
            template_key = d['name'][0:2]
        if template_key in ['10_03', '10_06','10_07','10_08','10_10','10_11']:
            TUMOR = True
